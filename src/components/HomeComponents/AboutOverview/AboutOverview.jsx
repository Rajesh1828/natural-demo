...
const AboutOverview = () => {
    return (
        <div className="flex items-center bg-[#15398f] justify-between w-full md:h-[670px] md:flex-row flex-col">
            {/* Left Image */}
            <motion.div  initial={{opacity:0 , x:-100}} whileInView={{opacity:1,x:0}} transition={{duration:1}} viewport={{once:true,amount:0.5}} className="md:w-1/2 w-full flex justify-center items-center">
                <img src={assets.ab} alt="ab" className="w-[70%] " />
            </motion.div>
            ...
            <div className="md:w-1/2 w-full flex flex-col md:items-start items-center md:pl-10 px-5 py-10 gap-7">
                ...
                <div className="flex flex-col gap-6 justify-start  w-full">
                    <motion.h2  initial={{opacity:0 , y:10}} whileInView={{opacity:1,y:0}} transition={{duration:1,delay:0.5}} viewport={{once:true,amount:0.5}} className="text-3xl md:text-4xl leading-tight  uppercase font-bold text-white  text-center md:text-left">
                        A sip of refreshment,
                        <br />
                        a taste of richness.
                    </motion.h2>
                    <motion.p initial={{opacity:0 , y:10}} whileInView={{opacity:1,y:0}} transition={{duration:1}} viewport={{once:true,amount:0.5}} className="text-md  text-white capitalize md:text-left">
                    ...
                    <motion.p initial={{opacity:0 , y:10}} whileInView={{opacity:1,y:0}} transition={{duration:1}} viewport={{once:true,amount:0.5}} className="text-md  text-white  md:text-left">
                    ...
                    <motion.h3 initial={{opacity:0 , x:-100}} whileInView={{opacity:1,x:0}} transition={{duration:1}} viewport={{once:true,amount:0.5}} className="md:text-medium font-bold text-white prata capitalize text-start md:text-left">
